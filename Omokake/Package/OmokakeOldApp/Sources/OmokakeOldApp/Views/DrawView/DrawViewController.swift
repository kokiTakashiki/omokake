...
final class DrawViewController: UIViewController, MTKViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = .makeColor(from: shareBackgroundColor)
    ...
    @IBAction
    func backMenuAction(_ sender: UIButton) {
...
extension DrawViewController {
    ...
    private func selectScreenShot() -> UIImage {
        ...
        return image.resizeImage(maxSize: 4_194_304) ?? UIImage.emptyImage(color: .black, frame: CGRect.zero)
    }
}
