...
final class PartSizeChangeViewController: UIViewController {
    ...
    // dammy
    private var pressurePointInit = simd_float2(x: -10000.0, y: -10000.0)
    private var pressureEndPInit = simd_float2(x: -1.0, y: -1.0)
    ...
    @IBAction
    private func startButtonAction(_ sender: UIButton) {
        present()
    }

    @IBAction
    private func dismissButton(_ sender: UIButton) {
    ...
    @IBAction
    private func selectColorAction(_ sender: UIButton) {
...
extension PartSizeChangeViewController {
    private func selectBackGroundColor(_ selectButtonTag: Int) -> MTLClearColor {
        ...
        case 1:
            .convertUIColor(UIColor(resource: .backgroundMagenta))
        case 2:
            .convertUIColor(UIColor(resource: .backgroundCyaan))
        case 3:
            .convertUIColor(UIColor(resource: .backgroundGreen))
        case 4:
            .convertUIColor(UIColor(resource: .backgroundYellow))
        case 5:
            .convertUIColor(UIColor(resource: .backgroundOrange))
        case 6:
            .black
        default:
            .black
